...
<div class="mainDiv">
    <div class="cardStyle">
        <form action="{{URL('login')}}" method="POST" name="login" id="login">
            ...
            <div class="inputDiv">
                <a typeof="button" onclick="window.location='{{ url('/forgot_pin')}}'" class="forgotPassLabel" href="#" >Forgot password</a>
            </div>
            ...
            <div class="inputDiv">
                <a typeof="button" onclick="window.location='{{ url('/register')}}'" class="loginLabel" href="#" >Create an account</a>
            </div>
        </form>
    </div>
</div>
